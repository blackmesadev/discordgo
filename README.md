...
- [![Go Reference](https://pkg.go.dev/badge/github.com/blackmesadev/discordgo.svg)](https://pkg.go.dev/github.com/blackmesadev/discordgo)
- [![Go Walker](http://gowalker.org/api/v1/badge)](https://gowalker.org/github.com/blackmesadev/discordgo) 
...
- [DiscordGo Examples](https://github.com/blackmesadev/discordgo/tree/master/examples) - A collection of example programs written with DiscordGo
- [Awesome DiscordGo](https://github.com/blackmesadev/discordgo/wiki/Awesome-DiscordGo) - A curated list of high quality projects using DiscordGo

## Troubleshooting
For help with common problems please reference the 
[Troubleshooting](https://github.com/blackmesadev/discordgo/wiki/Troubleshooting) 
